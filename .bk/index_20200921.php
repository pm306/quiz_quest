...
/*.my_sw_lr{ width: 100%; top: 50px; position: relative; padding: 10px; }*/
/*.my_sw_lr img{ box-shadow: 0 0 2px 2px rgba(0,0,0,0.2); border-radius: 2px; display: inline; min-height: 100vh;}*/
...
<div class="row">
	<div class="col-md-12">
		...
		<div class="swiper-container my_sw_ud" dir="rtl">
			<div class="swiper-wrapper swiper-wrapper-ud">
...
<footer>
<div class="followBtn"><a href=""><img src="./img/icon01.png"></a><a href="">フォローする</a></div>
<div><a href=""><i class="fas fa-comment-dots"></i>9999</a></div>
...
var lrSwiper = new Swiper('.my_sw_ud', {
